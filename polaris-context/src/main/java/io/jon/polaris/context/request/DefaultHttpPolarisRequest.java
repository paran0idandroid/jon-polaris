...
import io.jon.polaris.common.time.SystemClock;
 ...
 * @version 1.0.0
 * @description HttpPolarisRequest实现类
 * @github https://github.com/binghe001
 * @copyright 公众号: 冰河技术
 */
public class DefaultHttpPolarisRequest implements HttpPolarisRequest {

    private final Logger logger = LoggerFactory.getLogger(HttpPolarisRequest.class);
    ...
    public DefaultHttpPolarisRequest(String uniqueId, Charset charset, String clientIp, String targetHost, String uri, HttpMethod method,
    ...
    @Override
    public void addOrUpdateCookie(org.asynchttpclient.cookie.Cookie cookie) {
