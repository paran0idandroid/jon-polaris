...
import io.jon.polaris.context.definition.ServiceDefinition;
...
public class ContextConfigCache implements ConfigCache{
     ...
     */
    private ConcurrentMap<String, ServiceDefinition> serviceDefinitionMap = new ConcurrentHashMap<>();
     ...
     */
    private ConcurrentMap<String, Set<ServiceInstance>>  serviceInstanceMap = new ConcurrentHashMap<>();
