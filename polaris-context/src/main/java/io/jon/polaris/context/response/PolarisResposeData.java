 ...
 * @copyright 公众号: 冰河技术
 */
public class PolarisResposeData implements Serializable {
    @Serial
    private static final long serialVersionUID = -488232224457861632L;
    ...
    public PolarisResposeData() {
    }

    public PolarisResposeData(HttpHeaders responseHeaders, String content, HttpResponseStatus httpResponseStatus, Response futureResponse) {
